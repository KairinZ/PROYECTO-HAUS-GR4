...
-- torneos.hs
-- ===========================================================
-- Módulo que implementa el sistema de lanzamiento automático
-- de múltiples torneos consecutivos.
-- 
-- Cuando un torneo termina (solo queda un robot vivo o ninguno),
-- automáticamente inicia un nuevo torneo con la misma configuración
...
-- | Versión modificada de runGameLogic que reinicia automáticamente
--   los torneos cuando terminan.
--   
--   Cuando detecta que un torneo ha terminado (countActiveRobots <= 1),
--   incrementa el contador de torneos. Si aún no se han completado 5 torneos,
--   reinicia automáticamente un nuevo torneo con la misma configuración.
--   Si ya se completaron 5 torneos, detiene el juego y muestra el mensaje.
--   
